<template>
	<div class="_formRoot">
		<FormSection>
			...
			<FormSwitch
				v-model="autoWatchReplied"
				class="_formBlock"
				@update:modelValue="save()"
			>
				{{ i18n.ts.autoWatchReplied }}
				<template #caption>{{
					i18n.ts.autoWatchRepliedDescription
				}}</template>
			</FormSwitch>

			<FormSwitch
				v-model="autoWatchBoosted"
				class="_formBlock"
				@update:modelValue="save()"
			>
				{{ i18n.ts.autoWatchBoosted }}
				<template #caption>{{
					i18n.ts.autoWatchBoostedDescription
				}}</template>
			</FormSwitch>

			<FormSwitch
				v-model="autoWatchQuoted"
				class="_formBlock"
				@update:modelValue="save()"
			>
				{{ i18n.ts.autoWatchQuoted }}
				<template #caption>{{
					i18n.ts.autoWatchQuotedDescription
				}}</template>
			</FormSwitch>

			<FormSwitch
				v-model="autoWatchReacted"
				class="_formBlock"
				@update:modelValue="save()"
			>
				{{ i18n.ts.autoWatchReacted }}
				<template #caption>{{
					i18n.ts.autoWatchReactedDescription
				}}</template>
			</FormSwitch>

			<FormSwitch
				v-model="autoWatchVoted"
				class="_formBlock"
				@update:modelValue="save()"
			>
				{{ i18n.ts.autoWatchVoted }}
				<template #caption>{{
					i18n.ts.autoWatchVotedDescription
				}}</template>
			</FormSwitch>
		</FormSection>
	</div>
